...
The 30 tools worth installing on every project, distilled from 991 catalog entries and 1019 evaluations. Each tool earned its slot by moving a quality signal — see the Evidence tiers below for how far each one was actually validated.
...
**Tier 1 — measured (29): install with confidence.** Run hands-on, with metrics (`MEASURED`) or at least a smoke test (`RUN`).
...
- **991 tools** are cataloged in [CATALOG.md](CATALOG.md) — this page is the curated subset

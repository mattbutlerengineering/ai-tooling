...
The ~25 tools worth installing on every project, distilled from 620 catalog entries and 532 evaluations. Each tool earned its slot by moving a quality signal in real testing.
...
- **620 tools** are cataloged in [CATALOG.md](CATALOG.md) — this page is the curated subset

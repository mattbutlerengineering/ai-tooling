...
The 30 tools worth installing on every project, distilled from 899 catalog entries and 922 evaluations. Each tool earned its slot by moving a quality signal — see the Evidence tiers below for how far each one was actually validated.
...
- **899 tools** are cataloged in [CATALOG.md](CATALOG.md) — this page is the curated subset

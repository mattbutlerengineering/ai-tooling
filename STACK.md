...
The ~25 tools worth installing on every project, distilled from 610 catalog entries and 517 evaluations. Each tool earned its slot by moving a quality signal in real testing.
...
- **610 tools** are cataloged in [CATALOG.md](CATALOG.md) — this page is the curated subset

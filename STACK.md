...
The 30 tools worth installing on every project, distilled from 752 catalog entries and 768 evaluations. Each tool earned its slot by moving a quality signal — see the Evidence tiers below for how far each one was actually validated.
...
- **752 tools** are cataloged in [CATALOG.md](CATALOG.md) — this page is the curated subset

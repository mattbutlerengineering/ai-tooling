...
The ~25 tools worth installing on every project, distilled from 474 catalog entries and 466 hands-on evaluations. Each tool earned its slot by moving a quality signal in real testing.
...
- **474 tools** are cataloged in [CATALOG.md](CATALOG.md) — this page is the curated subset

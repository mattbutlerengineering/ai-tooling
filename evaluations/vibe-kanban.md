...
A Kanban board to plan, dispatch, and review multiple coding agents (Claude Code, Codex, or any other) working in parallel — orchestrating and tracking their work from one board instead of juggling terminals by hand.

## How we tested it

**Evidence:** SOURCE-ONLY

We did **not** install or run this tool. This evaluation is source-grounded only: CATALOG.md's existing one-liner (★27K, Apache-2.0).

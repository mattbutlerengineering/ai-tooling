...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 598 evaluations
...
- [evaluations/](evaluations/) — 598 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

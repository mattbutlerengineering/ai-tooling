...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 216 evaluations
- [evaluations/](evaluations/) — 216 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 676 evaluations
...
- [evaluations/](evaluations/) — 676 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

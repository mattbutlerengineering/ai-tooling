...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 497 evaluations
...
- [evaluations/](evaluations/) — 497 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

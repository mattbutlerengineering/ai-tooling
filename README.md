...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 585 evaluations
...
- [evaluations/](evaluations/) — 585 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

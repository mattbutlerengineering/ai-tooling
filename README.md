...
- [CATALOG.md](CATALOG.md) — flat inventory of 776 tools with definitions, problem statements, and overlap markers
- [COMPARISON.md](COMPARISON.md) — all tools at a glance with evaluation status by dev loop stage
- [STACK.md](STACK.md) — the 30 tools worth installing, distilled from 792 evaluations
...
- [evaluations/](evaluations/) — 792 evaluation files: 322 carrying a verdict (ADOPT/KEEP/CONDITIONAL/SKIP/DEFER), 267 still at `discovery-log` — leads, not verdicts — and 203 stubs and comparison documents

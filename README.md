...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 568 evaluations
...
- [evaluations/](evaluations/) — 568 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

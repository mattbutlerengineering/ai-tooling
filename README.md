...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 490 evaluations
...
- [evaluations/](evaluations/) — 490 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

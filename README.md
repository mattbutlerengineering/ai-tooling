...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 213 evaluations
- [evaluations/](evaluations/) — 213 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

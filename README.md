...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 186 evaluations
- [evaluations/](evaluations/) — 186 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 174 evaluations
- [evaluations/](evaluations/) — 174 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

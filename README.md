...
- [evaluations/](evaluations/) — 785 evaluation files: 317 carrying a verdict (ADOPT/KEEP/CONDITIONAL/SKIP/DEFER), 272 still at `discovery-log` — leads, not verdicts — and 196 stubs and comparison documents

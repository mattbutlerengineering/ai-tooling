...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 660 evaluations
...
- [evaluations/](evaluations/) — 660 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

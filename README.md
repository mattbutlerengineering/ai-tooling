...
- [evaluations/](evaluations/) — 785 evaluation files: 319 carrying a verdict (ADOPT/KEEP/CONDITIONAL/SKIP/DEFER), 270 still at `discovery-log` — leads, not verdicts — and 196 stubs and comparison documents

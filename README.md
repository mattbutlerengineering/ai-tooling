...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 159 evaluations
- [evaluations/](evaluations/) — 159 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

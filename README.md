...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 210 evaluations
- [evaluations/](evaluations/) — 210 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

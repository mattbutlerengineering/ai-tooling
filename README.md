...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 154 evaluations
- [evaluations/](evaluations/) — 154 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

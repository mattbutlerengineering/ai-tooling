...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 578 evaluations
...
- [evaluations/](evaluations/) — 578 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

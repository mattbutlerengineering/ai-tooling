...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 139 evaluations
- [evaluations/](evaluations/) — 139 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

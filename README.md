...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 183 evaluations
- [evaluations/](evaluations/) — 183 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

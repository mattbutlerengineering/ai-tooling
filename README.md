...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 189 evaluations
- [evaluations/](evaluations/) — 189 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 195 evaluations
- [evaluations/](evaluations/) — 195 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

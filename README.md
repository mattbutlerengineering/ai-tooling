...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 608 evaluations
...
- [evaluations/](evaluations/) — 608 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

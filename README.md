...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 180 evaluations
- [evaluations/](evaluations/) — 180 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

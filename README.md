...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 206 evaluations
- [evaluations/](evaluations/) — 206 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

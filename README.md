...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 636 evaluations
...
- [evaluations/](evaluations/) — 636 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

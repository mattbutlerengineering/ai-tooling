...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 488 evaluations
...
- [evaluations/](evaluations/) — 488 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 177 evaluations
- [evaluations/](evaluations/) — 177 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 151 evaluations
- [evaluations/](evaluations/) — 151 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

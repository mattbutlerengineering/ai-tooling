...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 617 evaluations
...
- [evaluations/](evaluations/) — 617 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

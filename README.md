...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 215 evaluations
- [evaluations/](evaluations/) — 215 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

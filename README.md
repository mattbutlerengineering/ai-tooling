...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 647 evaluations
...
- [evaluations/](evaluations/) — 647 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

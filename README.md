...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 665 evaluations
...
- [evaluations/](evaluations/) — 665 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

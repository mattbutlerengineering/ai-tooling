...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 168 evaluations
- [evaluations/](evaluations/) — 168 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 191 evaluations
- [evaluations/](evaluations/) — 191 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 214 evaluations
- [evaluations/](evaluations/) — 214 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 145 evaluations
- [evaluations/](evaluations/) — 145 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

...
- [CATALOG.md](CATALOG.md) — flat inventory of 736 tools with definitions, problem statements, and overlap markers
- [COMPARISON.md](COMPARISON.md) — all tools at a glance with evaluation status by dev loop stage
- [STACK.md](STACK.md) — the 30 tools worth installing, distilled from 752 evaluations
...
- [evaluations/](evaluations/) — 752 evaluation files: 309 carrying a verdict (ADOPT/KEEP/CONDITIONAL/SKIP/DEFER), 275 still at `discovery-log` — leads, not verdicts — and 168 stubs and comparison documents

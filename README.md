...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 142 evaluations
- [evaluations/](evaluations/) — 142 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

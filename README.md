...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 203 evaluations
- [evaluations/](evaluations/) — 203 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

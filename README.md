...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 502 evaluations
...
- [evaluations/](evaluations/) — 502 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

...
- [CATALOG.md](CATALOG.md) — flat inventory of 989 tools with definitions, problem statements, and overlap markers
- [COMPARISON.md](COMPARISON.md) — all tools at a glance with evaluation status by dev loop stage
- [STACK.md](STACK.md) — the 30 tools worth installing, distilled from 1017 evaluations
...
- [evaluations/](evaluations/) — 1017 evaluation files: 350 carrying a verdict (ADOPT/KEEP/CONDITIONAL/SKIP/DEFER), 296 still at `discovery-log` — leads, not verdicts — and 371 stubs and comparison documents

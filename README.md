...
- [evaluations/](evaluations/) — 785 evaluation files: 315 carrying a verdict (ADOPT/KEEP/CONDITIONAL/SKIP/DEFER), 274 still at `discovery-log` — leads, not verdicts — and 196 stubs and comparison documents

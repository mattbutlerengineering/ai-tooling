...
- [CATALOG.md](CATALOG.md) — flat inventory of 967 tools with definitions, problem statements, and overlap markers
- [COMPARISON.md](COMPARISON.md) — all tools at a glance with evaluation status by dev loop stage
- [STACK.md](STACK.md) — the 30 tools worth installing, distilled from 995 evaluations
...
- [evaluations/](evaluations/) — 995 evaluation files: 349 carrying a verdict (ADOPT/KEEP/CONDITIONAL/SKIP/DEFER), 282 still at `discovery-log` — leads, not verdicts — and 364 stubs and comparison documents

...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 589 evaluations
...
- [evaluations/](evaluations/) — 589 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

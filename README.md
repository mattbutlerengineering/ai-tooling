...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 661 evaluations
...
- [evaluations/](evaluations/) — 661 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

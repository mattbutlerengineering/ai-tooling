...
- [CATALOG.md](CATALOG.md) — flat inventory of 889 tools with definitions, problem statements, and overlap markers
- [COMPARISON.md](COMPARISON.md) — all tools at a glance with evaluation status by dev loop stage
- [STACK.md](STACK.md) — the 30 tools worth installing, distilled from 909 evaluations
...
- [evaluations/](evaluations/) — 909 evaluation files: 340 carrying a verdict (ADOPT/KEEP/CONDITIONAL/SKIP/DEFER), 265 still at `discovery-log` — leads, not verdicts — and 304 stubs and comparison documents

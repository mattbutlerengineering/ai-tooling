...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 220 evaluations
- [evaluations/](evaluations/) — 220 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

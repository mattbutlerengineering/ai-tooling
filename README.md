...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 197 evaluations
- [evaluations/](evaluations/) — 197 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 622 evaluations
...
- [evaluations/](evaluations/) — 622 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

...
- [CATALOG.md](CATALOG.md) — flat inventory of 991 tools with definitions, problem statements, and overlap markers
- [COMPARISON.md](COMPARISON.md) — all tools at a glance with evaluation status by dev loop stage
- [STACK.md](STACK.md) — the 30 tools worth installing, distilled from 1019 evaluations
...
- [evaluations/](evaluations/) — 1019 evaluation files: 351 carrying a verdict (ADOPT/KEEP/CONDITIONAL/SKIP/DEFER), 296 still at `discovery-log` — leads, not verdicts — and 372 stubs and comparison documents

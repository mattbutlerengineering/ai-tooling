...
- [CATALOG.md](CATALOG.md) — flat inventory of 797 tools with definitions, problem statements, and overlap markers
- [COMPARISON.md](COMPARISON.md) — all tools at a glance with evaluation status by dev loop stage
- [STACK.md](STACK.md) — the 30 tools worth installing, distilled from 813 evaluations
...
- [evaluations/](evaluations/) — 813 evaluation files: 324 carrying a verdict (ADOPT/KEEP/CONDITIONAL/SKIP/DEFER), 270 still at `discovery-log` — leads, not verdicts — and 219 stubs and comparison documents

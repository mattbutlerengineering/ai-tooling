...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 201 evaluations
- [evaluations/](evaluations/) — 201 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

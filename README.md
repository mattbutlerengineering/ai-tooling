...
- [CATALOG.md](CATALOG.md) — flat inventory of 824 tools with definitions, problem statements, and overlap markers
- [COMPARISON.md](COMPARISON.md) — all tools at a glance with evaluation status by dev loop stage
- [STACK.md](STACK.md) — the 30 tools worth installing, distilled from 848 evaluations
...
- [evaluations/](evaluations/) — 848 evaluation files: 337 carrying a verdict (ADOPT/KEEP/CONDITIONAL/SKIP/DEFER), 266 still at `discovery-log` — leads, not verdicts — and 245 stubs and comparison documents

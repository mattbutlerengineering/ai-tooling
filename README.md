...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 629 evaluations
...
- [evaluations/](evaluations/) — 629 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

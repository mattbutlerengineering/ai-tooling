...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 165 evaluations
- [evaluations/](evaluations/) — 165 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

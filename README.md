...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 219 evaluations
- [evaluations/](evaluations/) — 219 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

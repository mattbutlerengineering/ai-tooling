...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 157 evaluations
- [evaluations/](evaluations/) — 157 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

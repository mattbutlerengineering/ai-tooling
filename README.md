...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 199 evaluations
- [evaluations/](evaluations/) — 199 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

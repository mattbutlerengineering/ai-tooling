...
- [CATALOG.md](CATALOG.md) — flat inventory of 642 tools with definitions, problem statements, and overlap markers
- [COMPARISON.md](COMPARISON.md) — all tools at a glance with evaluation status by dev loop stage
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 570 evaluations
...
- [evaluations/](evaluations/) — 570 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

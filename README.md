...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 208 evaluations
- [evaluations/](evaluations/) — 208 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

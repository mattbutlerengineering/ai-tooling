...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 212 evaluations
- [evaluations/](evaluations/) — 212 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

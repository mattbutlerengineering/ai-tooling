...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 615 evaluations
...
- [evaluations/](evaluations/) — 615 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

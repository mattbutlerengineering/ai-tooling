...
- [evaluations/](evaluations/) — 785 evaluation files: 320 carrying a verdict (ADOPT/KEEP/CONDITIONAL/SKIP/DEFER), 269 still at `discovery-log` — leads, not verdicts — and 196 stubs and comparison documents

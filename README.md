...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 162 evaluations
- [evaluations/](evaluations/) — 162 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

...
- [CATALOG.md](CATALOG.md) — flat inventory of 679 tools with definitions, problem statements, and overlap markers
- [COMPARISON.md](COMPARISON.md) — all tools at a glance with evaluation status by dev loop stage
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 693 evaluations
...
- [evaluations/](evaluations/) — 693 evaluation files: 296 carrying a verdict (ADOPT/KEEP/CONDITIONAL/SKIP/DEFER), 258 still at `discovery-log` — leads, not verdicts — and 139 stubs and comparison documents

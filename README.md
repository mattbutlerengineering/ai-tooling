...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 171 evaluations
- [evaluations/](evaluations/) — 171 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

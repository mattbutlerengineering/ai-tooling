...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 193 evaluations
- [evaluations/](evaluations/) — 193 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

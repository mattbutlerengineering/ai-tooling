...
- [STACK.md](STACK.md) — the ~25 tools worth installing, distilled from 564 evaluations
...
- [evaluations/](evaluations/) — 564 evidence-based evaluations with verdicts (ADOPT/CONDITIONAL/SKIP)

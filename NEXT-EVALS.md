...
_Showing the top 25 of 464 discovery-log candidates — 439 not shown (no silent cap: rerun and read the source for the tail)._
...
| 3 | ECC | Implement | 38.2 | pressure 14, gap 8.2 | `/evaluate-tool ECC` |
| 4 | OpenHands | Implement | 38.2 | pressure 14, gap 8.2 | `/evaluate-tool OpenHands` |
| 5 | goose | Implement | 38.2 | pressure 14, gap 8.2 | `/evaluate-tool goose` |
| 6 | langfuse | Outer Loop | 37.8 | pressure 15, gap 7.8 | `/evaluate-tool langfuse` |
| 7 | agent-browser | Verify | 37.6 | pressure 14, gap 7.6 | `/evaluate-tool agent-browser` |
...
| 25 | ghostsecurity/skills | Review | 27.3 | pressure 9, gap 7.3 | `/evaluate-tool ghostsecurity/skills` |

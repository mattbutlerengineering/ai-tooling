...
| [mattpocock/skills](https://github.com/mattpocock/skills) | plugin | Skills for Real Engineers — v1 installable plugin (17 skills) from a working dev's .claude directory | Need practical, composable, multi-agent skills from a working dev | agent-skills, everything-claude-code |

...
| Name | Type | One-liner | Problem it solves | Overlaps with |
|------|------|-----------|-------------------|---------------|
| [GSD (Get Shit Done)](https://github.com/open-gsd/gsd-core) | framework | Context-engineering Discuss->Plan->Execute->Verify->Ship loop with restricted-tool subagents and durable STATE.md/CONTEXT.md (active repo open-gsd/gsd-core; formerly gsd-build/get-shit-done) | Need structured, context-rot-resistant orchestration around AI-assisted development | superpowers, feature-dev, spec-kit |

...
- `CATALOG.md` — flat inventory of all tools, organized by category with overlap markers
- `WORKFLOW.md` — recommended tool stack per ACMM level with exclusions and rationale
- `skills/` — installable skills for maintaining the workflow

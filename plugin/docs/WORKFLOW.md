...
Tools are only half of it — the mental models matter as much. [LEARNING.md](https://github.com/mattbutlerengineering/ai-tooling/blob/main/LEARNING.md)

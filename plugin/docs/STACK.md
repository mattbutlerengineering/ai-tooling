...
The ~25 tools worth installing on every project, distilled from 320 catalog entries and 160+ hands-on evaluations. Each tool earned its slot by moving a quality signal in real testing.
...
- **320 tools** are cataloged in [CATALOG.md](CATALOG.md) — this page is the curated subset

...
| **P3 backlog** | everything else | 283 | leave; stamp `**Last triaged:**` only |
...
| spec-kit | Plan | 34.3 | pressure 13, gap 6.3 | `/evaluate-tool spec-kit` |
...
| OpenSpec | Plan | 28.3 | pressure 10, gap 6.3 | `/evaluate-tool OpenSpec` |
...
| BMAD-METHOD | Plan | 24.3 | pressure 8, gap 6.3 | `/triage-lead BMAD-METHOD` |
| Understand-Anything | Plan | 24.3 | pressure 8, gap 6.3 | `/triage-lead Understand-Anything` |
...
## P3 backlog — 283 leads

_leave; stamp `**Last triaged:**` only._

_Listing 12 of 283 — rerun `python3 triage.py` and read the source for the tail (no silent cap)._

| Tool | Stage | Score | Why (pressure/gap) | Command |
|------|-------|-------|--------------------|---------|
| claude-hud | Plan | 26.3 | pressure 9, gap 6.3 | `/triage-lead claude-hud` |
